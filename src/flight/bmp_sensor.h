...
// bestätigt; der Adafruit-Default wäre 0x77). QNH fest 1013,25 hPa
// (Standardatmosphäre, keine Boden-Kalibrierung — YAGNI): die Höhe ist damit
// eine RELATIVE Größe, für die Flugphasen-Erkennung reicht die Änderung.
//
