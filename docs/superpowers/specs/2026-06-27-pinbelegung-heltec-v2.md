...
| **OLED SDA** (I²C) | **4** | I²C-Bus — wird mit BME280/MPU-6050 **geteilt** |
...
|---|---|---|---|---|---|
| **NEO-6M GPS** | UART2 | GPS **TX** → ESP32 **RX** | **23** | 3,3 V | ESP32 empfängt NMEA + UBX-ACK |
| | | GPS **RX** ← ESP32 **TX** | **17** | 3,3 V | **nötig** für UBX-Flight-Mode-Befehl! |
| | | *(gekreuzt: TX↔RX)* | | | am Board verifiziert — UBX-ACK kommt zurück |
| | | VCC / GND | 3V3 / GND | | 9600 Baud |
| **BME280** | I²C | SDA / SCL | **4 / 15** | 3,3 V | teilt I²C-Bus mit OLED; Adr. 0x76/0x77 |
